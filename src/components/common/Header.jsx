...
const Header = () => {
  ...
  return (
    <div className="flex sticky w-full bg-white top-0 z-[2000] sm:justify-center justify-between items-center sm:space-x-4 shadow-[0_4px_8px_-1px_rgba(0,0,0,0.1)]">
